...
assert.match(css,/--forest:#234a38/);assert.match(css,/--surface:#fffdf7/);assert.match(css,/\.premium-hero\{/);assert.match(css,/\.home-actions\{/);assert.match(css,/\.mobile-tabbar\{/);assert.match(css,/\.capture-primary\{/);assert.match(css,/\.observation-card\{/);assert.match(css,/\.editorial-book-hero\{/);assert.match(css,/botanical-sprig\.svg/);assert.match(css,/@media\(max-width:620px\)/);
