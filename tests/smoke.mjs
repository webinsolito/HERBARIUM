...
assert.match(js,/status:'UNKNOWN'/);assert.match(js,/speciesCount\.textContent='0'/);assert.match(js,/item\.status==='UNKNOWN'/);assert.match(js,/renderBook/);assert.match(js,/renderAtlas/);
