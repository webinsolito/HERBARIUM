...
assert.match(sw,/herbarium-v1-shell-1/);assert.match(sw,/caches\.open/);assert.match(sw,/request\.mode==='navigate'/);assert.match(sw,/url\.origin!==self\.location\.origin/);assert.match(sw,/cdn\.jsdelivr\.net/);assert.match(sw,/huggingface\.co/);assert.match(sw,/trustedMlUrl/);
