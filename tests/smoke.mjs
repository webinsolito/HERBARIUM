...
assert.match(css,/--forest:#234a38/);assert.match(css,/--surface:#fffdf7/);assert.match(css,/\.fidelity-shell\{/);assert.match(css,/max-width:520px/);assert.match(css,/\.fidelity-hero\{/);assert.match(css,/\.fidelity-cards\{/);assert.match(css,/hero-approved\.webp/);assert.match(css,/\.mobile-tabbar\{/);assert.match(css,/\.capture-primary\{/);assert.match(css,/\.observation-card\{/);assert.match(css,/\.editorial-book-hero\{/);assert.match(css,/botanical-sprig\.svg/);assert.match(css,/\.editorial-banner\{/);assert.match(css,/@media\(max-width:620px\)/);
